...
class TestVlsirValidationErrors:
    ...
    def test_missing_model_field(self) -> None:
        ...
        with pytest.raises(ValueError, match=r"missing required fields.*model"):
            validate_vlsir_metadata(c)
    ...
    def test_missing_spice_type_field(self) -> None:
        ...
        with pytest.raises(ValueError, match=r"missing required fields.*spice_type"):
            validate_vlsir_metadata(c)
    ...
    def test_missing_port_order_field(self) -> None:
        ...
        with pytest.raises(ValueError, match=r"missing required fields.*port_order"):
            validate_vlsir_metadata(c)
    ...
    def test_port_map_invalid_component_port(self) -> None:
        ...
        with pytest.raises(
            ValueError, match=r"port_map contains component ports not found.*X"
        ):
            validate_vlsir_metadata(c)
